...
protocol UserInputValidatorProtocol {
	@discardableResult
	func validate(_ text: String, type validationType: ValidatorType) throws -> String
}

class UserInputValidator: UserInputValidatorProtocol {
	@discardableResult
	func validate(_ text: String, type validationType: ValidatorType) throws -> String {
